...
<tr>
    ...
    <tr>
        <td>Date of birth</td>
         <td>
            <input type="date" name="dob" required max="1/1/2022" placeholder="Enter Age as like NID information"><br>
        </td>
    ...
    <tr>
        <td>PIN</td>   
        <td>
            <input type="password" name="pin" required placeholder="*****" maxlength="5"><br>
       </td>
    </tr>
    ...
    <tr>
        <td>Phone Number</td>
        <td>
            <input type="number" name="phone" required max="99999999999999"  placeholder="016********"><br>
        </td>
    </tr>
<tr>
